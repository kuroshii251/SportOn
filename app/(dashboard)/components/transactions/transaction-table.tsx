...
const TransactionTable = ({onViewDetails, transactions}: TTransactionTableProps) => {
  ...
  return (
    <div className=" bg-white rounded-xl border mt-10 border-gray-300">
        ...
        <tbody>
          {transactions.map((data) => (
            ...
            >
              ...
              <td className="py-6 px-4 font-medium ">{data.customerName}</td>
              <td className="py-6 px-4 font-medium ">{data.customerContact}</td>
              <td className="py-6 px-4 font-medium ">
