            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="flex gap-7">
                    <div className="min-w-50">
                        <ImageUploadPreview label="Category Preview" value={imagePreview} onChange={(file) => {
                            setImageFile(file);
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            <div className="input-group-admin">
                                ...
                                <input type="text" id="name" value={formData.name} onChange={handleChange} name="categoryName" placeholder="e, g. Running" />
                            </div>
                             <div className="input-group-admin">
