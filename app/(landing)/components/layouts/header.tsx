...
const Header = () => {
  ...
  return (
    <header  className="sticky w-full z-100 backdrop-blur-xl bg-white/50">
     ...
     <Link href="/">
        ...
        <div className="relative flex gap-10 pr-10">
          <FiSearch size={24} />

          <button className="relative cursor-pointer" onClick={() => setIsCartPopupOpen((prev) => !prev)}>
